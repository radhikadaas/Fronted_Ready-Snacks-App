    ...
    <div className="min-h-screen bg-gray-900 text-white overflow-x-hidden">
      ...
      <div className="relative isolate w-full min-h-screen flex items-center justify-center px-4">
        ...
        <div aria-hidden="true" className="absolute inset-0 -z-10 overflow-hidden">
          <div className="absolute inset-0 bg-linear-to-b from-indigo-900/60 to-gray-900 opacity-90"></div>
        ...
        <div className="text-center max-w-2xl mx-auto">
          ...
          <div className="mt-8 flex items-center justify-center gap-4">
            ...
            <Link to="/cart" className="text-sm font-semibold text-gray-200 hover:text-white">
              View Cart →
            </Link>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          ...
          {products.map((p) => (
            <Link
              ...
              rounded-xl p-3 shadow-md transition hover:scale-[1.03] hover:bg-white/20"
            >
              {/* IMAGE */}
              <img
                src={p.image}
              ...
              <p className="text-gray-400 text-sm mt-2 line-clamp-2">
                {p.description ? p.description.slice(0, 80) + "..." : "No description available."}
              </p>
